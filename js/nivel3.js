...
// const mediaLinks = document.querySelectorAll('h1');
...
const tituloViejo = document.querySelector('h1').textContent;
console.log(tituloViejo);
document.querySelector('h1').textContent = 'Chau r/argentina-programa';
console.log(tituloViejo);
...
document.querySelector('img').src = 'https://images.unsplash.com/photo-1734639528206-59e0864b3863?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
...
/*
   Creando nuevos nodos (Elementos)
    ...
    nuevoParrafo.appendChild(textoParrafo); // nuevoParrafo.textContent = 'Yeee!';
