...
// const comidasFavoritas = ['faina', 'asado'];
...
// const cosasAleatorias = [2, 'libro', 'hoy es Sabado', 10];
// console.log(cosasAleatorias.length);
...
// const comidasFavoritas = ['faina', 'asado', 'provoleta'];
