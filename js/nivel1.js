...
// let miNombre = 'Fabricio';
// let miEdad = 37;

// alert(saludo + ', mi nombre es ' + miNombre + ' y mi edad es ' + miEdad);
...
//     const saludo = saludoInicial + ' ' + nombre + '. Tu edad es ' + edad + '. ' + saludoFinal + '.';
//     return saludo;
// }
...
// function codigoDespuesDelReturn(){
//     console.log('este console.log si se ejecuta');
//     return 1;
//     console.log('este no'); //Esta línea nunca se ejecuta
// }
...
// console.log(restar(numero1, nro2));
...
/*
    ...
    if (numero1 > 10) {
        console.log('este numero es muy alto');
    } else {
...
// const operador = prompt('Ingrese el operador + o -');
// const numero1 = 2;
// const numero2 = 1;
...
// const numero = 1;
// if (numero > 10){
//     console.log('El numero es mayor a 1');
// } else if (numero > 2){
//     console.log('El numero es mayor a 2');
// } else {
//     console.log('El numero no es mayor a 10 ni mayor a 2');
// }
...
// const operador = prompt('¿Qué operador quieres usar? (+, -, *, /)');
// const numero1 = Number(prompt('Ingresá el primer numero'));
// const numero2 = Number(prompt('Ingresá el segundo numero'));
...
/*
    ...
    const unBooleano = 1 < 2;

    Después podemos chequear si 'bool' es verdadero o falso (true o false) usando console.log

    console.log(unBooleano); // Devuelve veradero (TRUE), porque 1 es menor a 2
    console.log(!unBooleano); // devuelve "no verdadero"... es decir falso (FALSE)
    console.log(unBooleano); // El valor original no se ve afectado, sigue siendo veradero, TRUE
